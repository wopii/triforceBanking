 ...
 * Copyright (c) 2009-2011 by triforceBanking, Inc. All Rights Reserved.
...
//@interface triforceBankingObject : NSObject
//@end

@interface triforceBankingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[triforceBankingObject class]])
		{
			for (NSString *key in [[(triforceBankingObject*)o modules] allKeys])
			{
