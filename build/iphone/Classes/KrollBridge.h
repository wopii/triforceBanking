...
@interface triforceBankingObject : KrollCoverageObject {
#else
@interface triforceBankingObject : KrollObject {
#endif
@private
...
extern NSString * triforceBanking$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	triforceBankingObject *_triforcebanking;
	BOOL shutdown;
