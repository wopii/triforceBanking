...
// in simulator we redefine to format for triforceBanking Developer console
...
{\
	NSString * exceptionName = [@"org.triforcebanking." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.triforcebanking";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItriforceBankingNativeItemNone = -1, 
	UItriforceBankingNativeItemSpinner = -2,
	UItriforceBankingNativeItemProgressBar = -3,
	
	UItriforceBankingNativeItemSlider = -4,
	UItriforceBankingNativeItemSwitch = -5,
	UItriforceBankingNativeItemMultiButton = -6,
	UItriforceBankingNativeItemSegmented = -7,
	
	UItriforceBankingNativeItemTextView = -8,
	UItriforceBankingNativeItemTextField = -9,
	UItriforceBankingNativeItemSearchBar = -10,
	
	UItriforceBankingNativeItemPicker = -11,
	UItriforceBankingNativeItemDatePicker = -12,
	
	UItriforceBankingNativeItemInfoLight = -13,
	UItriforceBankingNativeItemInfoDark = -14,
	
	UItriforceBankingNativeItemDisclosure = -15,
	
	UItriforceBankingNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all triforceBanking instances of
